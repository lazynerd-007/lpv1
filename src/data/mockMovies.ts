...
export const mockMovies: Movie[] = [
  ...
  },
  {
    ...
    director: 'Kemi Adetiba',
    producer: 'Kemi Adetiba',
    cast: ['Sola Sobowale', 'Adesua Etomi', 'Reminisce', 'Jide Kosoko', 'Toni Tones'],
    plotSummary: 'A businesswoman\'s political ambitions are threatened when her past catches up with her in this gripping tale of power, politics, and corruption.',
    posterUrl: 'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=Nigerian%20crime%20drama%20powerful%20businesswoman%20political%20thriller%20Lagos&image_size=portrait_4_3',
  ...
  },
  {
    ...
    plotSummary: 'A young woman fights to save her father\'s bus company from bankruptcy and corruption while proving herself in a male-dominated industry.',
    posterUrl: 'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=Nigerian%20family%20drama%20strong%20woman%20business%20transportation%20company&image_size=portrait_4_3',
    productionCompany: 'The Entertainment Network',
    filmingLocations: ['Enugu', 'Lagos'],
    productionState: 'Enugu',
    boxOfficeNG: '₦150 million',
    streamingPlatforms: ['Netflix'],
    awards: ['First Nigerian Netflix Original'],
    lemonPieRating: 7.8,
    userRating: 8.1,
    criticRating: 7.5,
    reviewCount: 987
  },
  {
    ...
    plotSummary: 'A police detective investigates a series of murders in a colonial Nigerian town on the eve of independence in 1960.',
    posterUrl: 'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=1960s%20Nigerian%20colonial%20mystery%20thriller%20independence%20detective%20investigation&image_size=portrait_4_3',
    productionCompany: 'Golden Effects Pictures',
    filmingLocations: ['Ilara-Mokin', 'Ondo State'],
    productionState: 'Ondo',
    boxOfficeNG: '₦180 million',
    streamingPlatforms: ['Netflix', 'iROKOtv'],
    awards: ['AMVCA Best Picture', 'AMVCA Best Director'],
    lemonPieRating: 8.2,
    userRating: 8.4,
    criticRating: 8.0,
    reviewCount: 743
  },
  {
    ...
    cast: ['Chiwetel Ejiofor', 'Thandiwe Newton', 'Anika Noni Rose', 'Joseph Mawle'],
    plotSummary: 'Two sisters navigate love and loss during the Nigerian Civil War in this adaptation of Chimamanda Ngozi Adichie\'s acclaimed novel.',
    posterUrl: 'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=Nigerian%20civil%20war%20drama%20sisters%20love%20loss%20Biafra%20historical&image_size=portrait_4_3',
    productionCompany: 'Potboiler Productions',
    filmingLocations: ['Calabar', 'Cross River State'],
    productionState: 'Cross River',
    boxOfficeNG: '₦95 million',
    streamingPlatforms: ['Prime Video', 'Showmax'],
    awards: ['AMVCA Best Adapted Screenplay'],
    lemonPieRating: 7.9,
    userRating: 8.2,
    criticRating: 7.6,
    reviewCount: 654
  },
  {
    ...
    director: 'Kunle Afolayan',
    producer: 'Kunle Afolayan',
    cast: ['Kunle Afolayan', 'Ramsey Nouah', 'Omoni Oboli', 'Jide Kosoko'],
    plotSummary: 'Two friends discover an ancient figurine that brings them luck, but at a terrible cost as they learn about the power of Yoruba mysticism.',
    posterUrl: 'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=Nigerian%20supernatural%20thriller%20ancient%20figurine%20Yoruba%20mysticism%20friendship&image_size=portrait_4_3',
    productionCompany: 'Golden Effects Pictures',
    filmingLocations: ['Osun State', 'Lagos'],
    productionState: 'Osun',
    boxOfficeNG: '₦65 million',
    streamingPlatforms: ['iROKOtv', 'YouTube'],
    awards: ['AMVCA Best Indigenous Film'],
    lemonPieRating: 7.6,
    userRating: 7.8,
    criticRating: 7.4,
    reviewCount: 523
  },
  {
    id: 'new6',
    title: 'Living in Bondage: Breaking Free',
    localTitle: 'Ibi Ugwu: Nwere Onwe',
    releaseDate: '2019-11-08',
    runtime: 115,
    ...
    director: 'Ramsey Nouah',
    producer: 'Steve Gukas',
    cast: ['Ramsey Nouah', 'Nancy Isime', 'Jidekene Achufusi', 'Swanky JKA'],
    plotSummary: 'The son of a man who made a deal with dark forces must break the family curse in this sequel to the classic Nollywood film.',
    posterUrl: 'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=Nigerian%20supernatural%20sequel%20family%20curse%20dark%20forces%20modern%20Nollywood&image_size=portrait_4_3',
    productionCompany: 'Play Network Studios',
    filmingLocations: ['Lagos', 'Anambra'],
    productionState: 'Lagos',
    boxOfficeNG: '₦125 million',
    streamingPlatforms: ['Netflix', 'Prime Video'],
    awards: ['AMVCA Best Visual Effects'],
    lemonPieRating: 7.3,
    userRating: 7.7,
    criticRating: 6.9,
    reviewCount: 892
  },
  {
    ...
    director: 'Kunle Afolayan',
    producer: 'Kunle Afolayan',
    cast: ['Temi Otedola', 'Jimmy Jean-Louis', 'Adjetey Anang', 'Joke Silva'],
    plotSummary: 'A graduate student fights against sexual harassment and corruption in academia while pursuing justice and her academic dreams.',
    posterUrl: 'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=Nigerian%20academic%20drama%20university%20student%20justice%20harassment%20education&image_size=portrait_4_3',
    productionCompany: 'KAP Motion Pictures',
    filmingLocations: ['Ile-Ife', 'Senegal'],
    productionState: 'Osun',
    boxOfficeNG: '₦85 million',
    streamingPlatforms: ['Netflix'],
    awards: ['AMVCA Best Supporting Actress'],
    lemonPieRating: 7.7,
    userRating: 8.0,
    criticRating: 7.4,
    reviewCount: 678
  },
  {
    ...
    producer: 'Niyi Akinmolayan',
    cast: ['Timini Egbuson', 'Toyin Abraham', 'Bimbo Ademoye', 'Broda Shaggi'],
    plotSummary: 'A chance encounter in a stuck elevator leads to an unexpected friendship and life-changing moments for two strangers.',
    posterUrl: 'https://trae-api-sg.mchost.guru/api/ide/v1/text_to_image?prompt=Nigerian%20comedy%20drama%20elevator%20stuck%20friendship%20unexpected%20encounter%20Lagos&image_size=portrait_4_3',
    productionCompany: 'Anthill Studios',
    filmingLocations: ['Lagos'],
    productionState: 'Lagos',
    boxOfficeNG: '₦78 million',
