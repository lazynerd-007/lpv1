  ...
  <div class="bg-gray-50 min-h-screen">
    ...
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <form @submit.prevent="handleSubmit" novalidate>
            ...
            <div class="mb-4">
              ...
              <input 
                ...
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400 focus:border-orange-400 outline-none transition-colors"
                aria-required="false"
              >
            </div>
            ...
            <div class="mb-4">
              ...
              <select 
                ...
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400 focus:border-orange-400 outline-none transition-colors bg-white"
              >
        ...
        <!-- Contact Information -->
        <div class="bg-white rounded-lg shadow-md p-6 md:p-8 h-fit">
          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <div class="flex space-x-4">
                <!-- Facebook -->
                <a href="#" class="bg-gray-100 p-2 rounded-full hover:bg-gray-200 transition-colors" aria-label="Facebook">
                  <svg class="h-5 w-5 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.77 7.46H14.5v-1.9c0-.9.6-1.1 1-1.1h3V.5h-4.33C10.24.5 9.5 3.44 9.5 5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4z"/>
                  </svg>
                </a>
                <!-- Twitter -->
                <a href="#" class="bg-gray-100 p-2 rounded-full hover:bg-gray-200 transition-colors" aria-label="Twitter">
                  <svg class="h-5 w-5 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                  </svg>
                </a>
                <!-- Instagram -->
                <a href="#" class="bg-gray-100 p-2 rounded-full hover:bg-gray-200 transition-colors" aria-label="Instagram">
                  <svg class="h-5 w-5 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
